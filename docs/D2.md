...
**Descrizione:** L’utente ha la possibilità di effettuare una ricerca nell’archivio tramite il nome dell’esame e/o del professore. I risultati possono poi venire filtrati e ordinati.
...
**Descrizione:** L’utente, inserendo una parola chiave in due barre di ricerca nella landing page, avvia una ricerca che mostra le statistiche relative ai risultati trovati.
